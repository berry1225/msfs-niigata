...
**ほぼ完全に見えなくするやり方もありましたが、どうやって設定したか分からず再現不可能でした。**
...
ちょっと前に出したくらいじゃ解決しませんし、だからといって前に出し過ぎると近距離で見た時にズレまくりで風情が台無しです。
遠景を取るか近距離のリアリティを取るかという話なら、近距離のリアリティを優先して配置しておいた方がよさそうです。
ビルの間を縫うような飛行をしないとちゃんと見れない夜景もどうなんだ、っていう気持ちも無くはないですけどね。
