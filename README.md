...
民家とか道路とか全部Google地図から持ってこいとかそういう話ですよね。

全部フォトグラメトリにするメリットはいくらかあると思いますが、逆にデメリットもいくつかあります。
* 夜景がない
* 境界部分が不自然になる
* そもそもの動作が重い
...
上記の点を踏まえて、少なくともわたしが作る新潟周辺のsceneryは「一部の建物のみ」を置く形としています。

~というか「全部フォトグラメトリじゃないと嫌だ！！」って人はつべこべ言ってないで日本語wikiの手順見て自分で作ればいいと思うんですよ。~

加えて、わたしの場合は「デフォルトの自動生成が機能向上する」可能性にも備えています。前述のOSMのデータ反映の件もそうですけれど。

それはそれとして、MSFS公式が各地方都市のフォトグラメトリ充実させてくれるなら万々歳なんですけどね。3D地図のない長岡や上越なども含めて。
