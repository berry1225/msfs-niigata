...
オブジェクトの数が多すぎると遠景で読み込んでくれないようです。なので、1平面ごとにレイヤー(オブジェクト)を統合するなど工夫するといいかもしれません。要するに、北側の窓、南側の窓、西側の窓、東側の窓、で合計4つのレイヤーだけにする、みたいな。(もっとも、1平面あたり20～30とか作らなければ大丈夫っぽいですが)
...
そもそもの新潟シーナリーも、全部配置するのが面倒だから高いものと目立つものから順番にやってますし。そういうもの。
