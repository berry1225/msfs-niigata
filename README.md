...
やたらGoogleを持ち上げてMicrosoftを蔑みたがる動物も中にはいますが、冷静に考えたらGoogle地図だってそんなに万能ではないですし。
そういう意味でも、わたしはこれからのMSFSの機能向上に期待したいと思います。

### 「ぶっちゃけ、Googleのデータ流用してるのってどうなの？」

[私見をこのへんにまとめました](https://twitter.com/usagiair/status/1399983070543970306)。
現実的な問題では、利害関係で対立したり、よほど度を超えた悪用(お金を稼いだり)をしたりしていなければ大丈夫、というのが界隈の一般的な認識のようです。
あまり胡坐をかきすぎないでね、というくらいで。
