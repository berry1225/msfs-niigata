...
マテリアルがなかったり違ったりしてたらマテリアルを選び直して、
マテリアル上の頂点を頑張って移動させて正確な外観になるように修正します。
できれば最初のオブジェクト作ってる時に教えてほしかった･･･

> ・朱鷺メッセやメディアシップのロゴってどうやって光らせてるの？

オブジェクトを光らせるんじゃなくて、発光体を配置しています。オブジェクトモードで追加→ライト→ポイント。
